...
async def get_concrete(mirror_less_url: str, mirror: Union[str, None] = Header(default="https://hdrezka.ag/")):
    url = mirror + mirror_less_url
...
async def search(query: str, page: int, mirror: str = Header(default="https://hdrezka.ag/")):
    search_url: str = create_search_url(query, page, mirror)
...
async def get_content_by_categories(page: int = 1, type: str = "films", genre: str = "any", year: int = None, mirror: str = Header(default="https://hdrezka.ag/")):
...
def create_search_url(query: str, page: int, mirror: str):
    url = mirror
    url += f"search/?do=search&subaction=search&q={query}&page={page}"
    return url
