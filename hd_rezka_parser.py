...
class HdRezkaParser:
    ...
    def get_content_info(content, mirror):
        ...
        content_info["mirrorLessUrl"] = content.find(
            "a").attrs["href"].replace(mirror, "")
        ...
        content_info["shortInfo"] = content.find(
            "div", class_="b-content__inline_item-link").find("div").text
